...
#pragma GCC diagnostic pop
# 15 "spmv_csr_vector.cu"
template< class T> static void 
# 16
__wrapper__device_stub_spmv_csr_vector_kernel(T *&d_val, T *&d_vector, int *&d_cols, int *&d_ptr, int &N, T *&d_out) { ::cudaLaunchKernel(0, 0, 0, 0, 0, 0);}
#if 0
# 17
{ 
# 19
int t = __device_builtin_variable_threadIdx.x; 
# 22
int lane = t & (__device_builtin_variable_warpSize - 1); 
# 25
int warpsPerBlock = (__device_builtin_variable_blockDim.x) / __device_builtin_variable_warpSize; 
# 28
int row = ((__device_builtin_variable_blockIdx.x) * warpsPerBlock) + (t / __device_builtin_variable_warpSize); 
# 30
__attribute__((unused)) static volatile T vals[1024]; 
# 32
if (row < N) 
# 33
{ 
...
T sum = (0); 
# 39
for (int j = rowStart + lane; j < rowEnd; j += __device_builtin_variable_warpSize) 
# 40
{ 
# 41
int col = d_cols[j]; 
...
# 16
spmv_csr_vector_kernel(T *d_val, T *d_vector, int *d_cols, int *d_ptr, int N, T *d_out) 
# 17
{__wrapper__device_stub_spmv_csr_vector_kernel<T>(d_val,d_vector,d_cols,d_ptr,N,d_out);
# 61
return;}
#if 0
# 17
...
# 1 "spmv_csr_vector.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__23_spmv_csr_vector_cpp1_ii_8b1b4e91
# 1 "spmv_csr_vector.cudafe1.stub.c"
#include "spmv_csr_vector.cudafe1.stub.c"
# 1 "spmv_csr_vector.cudafe1.stub.c"
