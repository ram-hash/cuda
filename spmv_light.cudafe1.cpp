...
#pragma GCC diagnostic pop
# 14 "spmv_light.cu"
template< class T, int THREADS_PER_VECTOR, int MAX_NUM_VECTORS_PER_BLOCK> static void 
# 15
__wrapper__device_stub_spmv_light_kernel(int *&cudaRowCounter, int *&d_ptr, int *&d_cols, T *&d_val, T *&d_vector, T *&d_out, int &N) { ::cudaLaunchKernel(0, 0, 0, 0, 0, 0);}
#if 0
# 15
{ 
# 16
...
int rowStart, rowEnd; 
# 20
int laneId = (__device_builtin_variable_threadIdx.x) % (THREADS_PER_VECTOR); 
# 21
int vectorId = (__device_builtin_variable_threadIdx.x) / (THREADS_PER_VECTOR); 
# 22
int warpLaneId = (__device_builtin_variable_threadIdx.x) & (31); 
# 23
int warpVectorId = warpLaneId / THREADS_PER_VECTOR; 
# 25
__attribute__((unused)) static volatile int space[MAX_NUM_VECTORS_PER_BLOCK][2]; 
# 28
if (warpLaneId == 0) { 
# 29
...
# 32
row = (__shfl_sync(4294967295U, row, 0) + warpVectorId); 
# 34
while (row < N) { 
# 37
if (laneId < 2) { 
...
# 68
sum += __shfl_down_sync(4294967295U, sum, i); 
# 69
}  
# 72
if (laneId == 0) { 
...
#endif
# 14 "spmv_light.cu"
template< class T, int THREADS_PER_VECTOR, int MAX_NUM_VECTORS_PER_BLOCK>  __noinline__ void 
# 15
spmv_light_kernel(int *cudaRowCounter, int *d_ptr, int *d_cols, T *d_val, T *d_vector, T *d_out, int N) {__wrapper__device_stub_spmv_light_kernel<T,THREADS_PER_VECTOR,MAX_NUM_VECTORS_PER_BLOCK>(cudaRowCounter,d_ptr,d_cols,d_val,d_vector,d_out,N);
# 84
return;}
#if 0
# 15
...
# 1 "spmv_light.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__18_spmv_light_cpp1_ii_53d835b7
# 1 "spmv_light.cudafe1.stub.c"
#include "spmv_light.cudafe1.stub.c"
# 1 "spmv_light.cudafe1.stub.c"
